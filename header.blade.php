...
<head>
    <title>Medical Appointment Portal</title>
    <meta charset="utf-8" />
                ...
                <aside class="app-navbar">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                <a class="has-arrow" href="{{ asset('admin/dashboard') }}" aria-expanded="false">
                                    <i class="nav-icon ti ti-rocket"></i>
                                    <span class="nav-title">Dashboard</span>
                            </li>
                            <li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon fa fa-user"></i><span class="nav-title">Patients</span></a>
                                <ul aria-expanded="false">
                                    <li> <a href='{{ asset('admin/patient/add') }}'>Add Patient</a> </li>
                                    <li> <a href='{{ asset('admin/patient/list') }}'>Patient List</a> </li>
                                </ul>
                            </li>
                            <li>
                                <a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon fa fa-user-md"></i> <span class="nav-title">Doctors</span></a>
                                <ul aria-expanded="false">
                                    <li> <a href="{{ asset('admin/doctor/add') }}">Add Doctor</a> </li>
                                    <li> <a href="{{ asset('admin/doctor/list') }}">Doctor List</a> </li>
                                </ul>
                            </li>
                            <li><a href="{{ asset('admin/appointment/add') }}" aria-expanded="false"><i class="nav-icon fa fa-plus-square"></i><span class="nav-title">Book Appointment</span></a> </li>
                            <li><a href="{{ asset('admin/appointment/list') }}" aria-expanded="false"><i class="nav-icon fa fa-plus-square"></i><span class="nav-title">Appointment List</span></a> </li>

                            <li><a href="" aria-expanded="false"><i class="nav-icon fa fa-money"></i><span class="nav-title">Online Payment</span></a> </li>

                            <li><a href="{{ asset('logout') }}" aria-expanded="false"><i class="nav-icon fa fa-money"></i><span class="nav-title">Logout</span></a> </li>
